  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-2">
        <h2 className="text-3xl font-bold tracking-tight">GlobalLoader Component</h2>
        <p className="text-muted-foreground text-lg">
          A consistent loading indicator component with multiple variants for different use
          cases throughout the application.
        </p>
      </div>
      ...
      <section className="space-y-4">
        ...
        <p className="text-muted-foreground leading-relaxed">
          The GlobalLoader component provides a unified way to display loading states across
          the application. It features three variants optimized for different scenarios: a
          simple spinner, an inline loader with text, and a full container layout.
        </p>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground text-sm">
                A simple spinning icon. Use this when you need a minimal loading indicator.
              </p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground text-sm">
                Spinner with a message next to it. Perfect for inline loading states within
                components.
              </p>
...
/>`}</code>
              ...
              <div className="bg-blue-500/10 border-blue-500/20 rounded border p-3 text-sm">
                <p className="font-medium text-blue-700 dark:text-blue-400">💡 Use Case</p>
                <p className="text-muted-foreground mt-1">
                  Great for showing loading state within buttons, form sections, or list items.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground text-sm">
                Full container with centered spinner, title, and optional description. Best for
                page-level or card-level loading states.
              </p>

              <div className="space-y-3">
                <p className="text-sm font-medium">Preview (Basic):</p>
                <div className="bg-muted/50 rounded-lg border" style={{ minHeight: "200px" }}>
                  <GlobalLoader variant="container" message="Loading course data..." />
                </div>
              </div>
...
/>`}</code>
              ...
              <div className="space-y-3">
                <p className="text-sm font-medium">Preview (With Description):</p>
                <div className="bg-muted/50 rounded-lg border" style={{ minHeight: "250px" }}>
                  <GlobalLoader
                    variant="container"
...
/>`}</code>
              ...
              <div className="bg-blue-500/10 border-blue-500/20 rounded border p-3 text-sm">
                ...
                <p className="text-muted-foreground mt-1">
                  Add <code className="bg-muted rounded px-1">fullHeight</code> prop to center
                  content in the full viewport. Useful for page-level loading.
                </p>
                <Button
                  variant="outline"
                  size="sm"
              ...
              <tbody className="divide-y">
                <tr>
                  <td className="px-4 py-3">
                    <code className="bg-muted rounded px-1.5 py-0.5 text-sm">variant</code>
                  </td>
                ...
                <tr>
                  <td className="px-4 py-3">
                    <code className="bg-muted rounded px-1.5 py-0.5 text-sm">message</code>
                  </td>
                ...
                <tr>
                  <td className="px-4 py-3">
                    <code className="bg-muted rounded px-1.5 py-0.5 text-sm">title</code>
                  </td>
                  <td className="px-4 py-3 text-sm">string</td>
                  <td className="px-4 py-3 text-sm">-</td>
                  <td className="text-muted-foreground px-4 py-3 text-sm">
                ...
                <tr>
                  <td className="px-4 py-3">
                    <code className="bg-muted rounded px-1.5 py-0.5 text-sm">description</code>
                  </td>
                  <td className="px-4 py-3 text-sm">string</td>
                  <td className="px-4 py-3 text-sm">-</td>
                  <td className="text-muted-foreground px-4 py-3 text-sm">
                ...
                <tr>
                  <td className="px-4 py-3">
                    <code className="bg-muted rounded px-1.5 py-0.5 text-sm">fullHeight</code>
                  </td>
                ...
                <tr>
                  <td className="px-4 py-3">
                    <code className="bg-muted rounded px-1.5 py-0.5 text-sm">size</code>
                  </td>
                ...
                <tr>
                  <td className="px-4 py-3">
                    <code className="bg-muted rounded px-1.5 py-0.5 text-sm">className</code>
                  </td>
                  <td className="px-4 py-3 text-sm">string</td>
                  <td className="px-4 py-3 text-sm">-</td>
                  <td className="text-muted-foreground px-4 py-3 text-sm">
      ...
      <section className="space-y-4">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Here are two common patterns used in the Educado application for handling loading
          states with TanStack Query.
        </p>
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground text-sm">
                When fetching critical data that blocks the entire page (e.g., editing a
                course requires the course data to be loaded first). This pattern is used in
                the Course Editor page.
              </p>
              ...
              <div className="bg-yellow-500/10 border-yellow-500/20 rounded border p-3 text-sm">
                ...
                <p className="text-muted-foreground mt-1">
                  The user is editing a course. We need the course data fetched to pre-fill
                  the form, including possible relations. Without this data, the page cannot
                  function.
                </p>
              </div>
...
const getSectionComponent = () => {
  ...
  return <CourseEditorForm course={queryCourse} />;
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground text-sm">
                When fetching supplementary data for a form (e.g., categories for a
                multi-select). Uses the Card component's built-in loading and error states to
              ...
              <div className="bg-yellow-500/10 border-yellow-500/20 rounded border p-3 text-sm">
                ...
                <p className="text-muted-foreground mt-1">
                  In the Course Editor, categories are a separate relation in Strapi. When
                  editing, we need to query all available categories to populate a
                  multi-select dropdown. This uses usePaginatedData (which wraps TanStack
                  Query).
                </p>
              </div>
  ...
  <Form {...form}>
    ...
    />
              ...
              <div className="bg-green-500/10 border-green-500/20 rounded border p-3">
                ...
                <ul className="text-muted-foreground ml-4 mt-1 list-disc space-y-1 text-sm">
                  <li>
                    Card component creates a visual boundary for the loading/error state
                  </li>
                  <li>GlobalLoader is automatically used inside the Card</li>
                  <li>ErrorDisplay is automatically shown if there's an error</li>
                  <li>Easy to catch errors during rapid development</li>
                  <li>Can be refined later to show spinner only on the input</li>
                </ul>
              </div>
              ...
              <div className="bg-blue-500/10 border-blue-500/20 rounded border p-3 text-sm">
                ...
                <p className="text-muted-foreground mt-1">
                  Currently blocks the entire Card to catch errors during fast development.
                  Can later be changed to only show a spinner on the multi-select input and
      ...
      <section className="space-y-4">
        <h3 className="text-2xl font-semibold">Integration with Card Component</h3>
        <p className="text-muted-foreground leading-relaxed">
          The Card component has built-in support for GlobalLoader through its{" "}
          <code className="bg-muted rounded px-1.5 py-0.5">isLoading</code> prop and{" "}
...
>
  {/* Card content */}
            ...
            <p className="text-muted-foreground text-sm">
              When <code className="bg-muted rounded px-1">isLoading</code> is true, the Card
              automatically renders a GlobalLoader with container variant instead of the
              children.
            </p>
          </CardContent>
        </Card>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3">
          <Card>
            ...
            <CardContent>
              <ul className="text-muted-foreground ml-4 list-disc space-y-1 text-sm">
                <li>
                  <strong>spinner</strong> - Minimal loading indicator in tight spaces
                </li>
                <li>
                  <strong>inline</strong> - Loading state within a component or list item
                </li>
                <li>
                  <strong>container</strong> - Page or card-level loading with context
                </li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">2. Provide Clear Messages</CardTitle>
            </CardHeader>
            <CardContent className="text-muted-foreground text-sm">
              Always provide informative messages that tell users what's being loaded. Use
              i18n translations for consistency.
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="text-muted-foreground text-sm">
              Always handle the error state alongside loading. Use ErrorDisplay component
              with retry actions for better UX.
            </CardContent>
          </Card>

          <Card>
            <CardHeader>
              <CardTitle className="text-base">4. Use Card Integration</CardTitle>
            </CardHeader>
            <CardContent className="text-muted-foreground text-sm">
              Leverage the Card component's built-in loading/error support for cleaner code
