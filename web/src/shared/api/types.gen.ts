...
export type CourseGetCoursesRequest = {
    ...
    path?: never;
    query?: {
        readonly fields?: Array<'title' | 'description' | 'difficulty' | 'numOfRatings' | 'numOfSubscriptions' | 'creator_published_at' | 'admin_control_at' | 'createdAt' | 'updatedAt' | 'publishedAt'>;
        filters?: {
            [key: string]: unknown;
        };
        _q?: string;
        ...
        sort?: 'title' | 'description' | 'difficulty' | 'numOfRatings' | 'numOfSubscriptions' | 'creator_published_at' | 'admin_control_at' | 'createdAt' | 'updatedAt' | 'publishedAt' | Array<'title' | 'description' | 'difficulty' | 'numOfRatings' | 'numOfSubscriptions' | 'creator_published_at' | 'admin_control_at' | 'createdAt' | 'updatedAt' | 'publishedAt'> | {
            [key: string]: 'asc' | 'desc';
        } | Array<{
            [key: string]: 'asc' | 'desc';
        }>;
