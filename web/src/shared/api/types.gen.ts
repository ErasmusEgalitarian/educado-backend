...
export type ContentCreatorGetContentCreatorsRequest = {
    ...
    path?: never;
    query?: {
        readonly fields?: Array<'email' | 'password' | 'firstName' | 'lastName' | 'verifiedAt' | 'motivation' | 'currentCompany' | 'createdAt' | 'updatedAt' | 'publishedAt'>;
        filters?: {
            [key: string]: unknown;
        };
        _q?: string;
        ...
        sort?: 'email' | 'password' | 'firstName' | 'lastName' | 'verifiedAt' | 'motivation' | 'currentCompany' | 'createdAt' | 'updatedAt' | 'publishedAt' | Array<'email' | 'password' | 'firstName' | 'lastName' | 'verifiedAt' | 'motivation' | 'currentCompany' | 'createdAt' | 'updatedAt' | 'publishedAt'> | {
            [key: string]: 'asc' | 'desc';
        } | Array<{
            [key: string]: 'asc' | 'desc';
        }>;
