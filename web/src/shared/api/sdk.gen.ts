...
export const courseRelationGetCourseRelations = <ThrowOnError extends boolean = false>(options?: Options<CourseRelationGetCourseRelationsRequest, ThrowOnError>) => {
    return (options?.client ?? client).get<CourseRelationGetCourseRelationsResponses, CourseRelationGetCourseRelationsErrors, ThrowOnError, 'data'>({
        querySerializer: {
            parameters: {
                filters: {
                    object: {
        ...
        requestValidator: async (data) => {
            return await zCourseRelationGetCourseRelationsRequest.parseAsync(data);
        },
        responseStyle: 'data',
        url: '/course-relations',
        ...options
    });
};

export const courseRelationPostCourseRelations = <ThrowOnError extends boolean = false>(options: Options<CourseRelationPostCourseRelationsRequest, ThrowOnError>) => {
    return (options.client ?? client).post<CourseRelationPostCourseRelationsResponses, CourseRelationPostCourseRelationsErrors, ThrowOnError, 'data'>({
        requestValidator: async (data) => {
            return await zCourseRelationPostCourseRelationsRequest.parseAsync(data);
        },
        responseStyle: 'data',
        url: '/course-relations',
        ...options,
...
export const courseRelationDeleteCourseRelationsById = <ThrowOnError extends boolean = false>(options: Options<CourseRelationDeleteCourseRelationsByIdRequest, ThrowOnError>) => {
    return (options.client ?? client).delete<CourseRelationDeleteCourseRelationsByIdResponses, CourseRelationDeleteCourseRelationsByIdErrors, ThrowOnError, 'data'>({
        querySerializer: {
            parameters: {
                filters: {
                    object: {
        ...
        requestValidator: async (data) => {
            return await zCourseRelationDeleteCourseRelationsByIdRequest.parseAsync(data);
        },
        responseStyle: 'data',
        url: '/course-relations/{id}',
        ...options
    });
};

export const courseRelationGetCourseRelationsById = <ThrowOnError extends boolean = false>(options: Options<CourseRelationGetCourseRelationsByIdRequest, ThrowOnError>) => {
    return (options.client ?? client).get<CourseRelationGetCourseRelationsByIdResponses, CourseRelationGetCourseRelationsByIdErrors, ThrowOnError, 'data'>({
        querySerializer: {
            parameters: {
                filters: {
                    object: {
        ...
        requestValidator: async (data) => {
            return await zCourseRelationGetCourseRelationsByIdRequest.parseAsync(data);
        },
        responseStyle: 'data',
        url: '/course-relations/{id}',
        ...options
...
export const courseRelationPutCourseRelationsById = <ThrowOnError extends boolean = false>(options: Options<CourseRelationPutCourseRelationsByIdRequest, ThrowOnError>) => {
    return (options.client ?? client).put<CourseRelationPutCourseRelationsByIdResponses, CourseRelationPutCourseRelationsByIdErrors, ThrowOnError, 'data'>({
        requestValidator: async (data) => {
            return await zCourseRelationPutCourseRelationsByIdRequest.parseAsync(data);
        },
        responseStyle: 'data',
        url: '/course-relations/{id}',
        ...options,
 ...
 */
export const postCourseStatisticsStatisticsAction = <ThrowOnError extends boolean = false>(options: Options<PostCourseStatisticsStatisticsActionRequest, ThrowOnError>) => {
    return (options.client ?? client).post<PostCourseStatisticsStatisticsActionResponses, PostCourseStatisticsStatisticsActionErrors, ThrowOnError, 'data'>({
        requestValidator: async (data) => {
            return await zPostCourseStatisticsStatisticsActionRequest.parseAsync(data);
        },
        responseStyle: 'data',
        url: '/course-statistics/statistics-action',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
