 ...
 */
export const getFeedbackByCourseIdAverage = <ThrowOnError extends boolean = false>(options: Options<GetFeedbackByCourseIdAverageRequest, ThrowOnError>) => {
    return (options.client ?? client).get<GetFeedbackByCourseIdAverageResponses, GetFeedbackByCourseIdAverageErrors, ThrowOnError, 'data'>({
        requestValidator: async (data) => {
            return await zGetFeedbackByCourseIdAverageRequest.parseAsync(data);
        },
        responseStyle: 'data',
