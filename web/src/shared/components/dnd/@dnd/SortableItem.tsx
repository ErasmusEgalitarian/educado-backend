...
import { Section } from "@/course/types/Course";
import { CreateExercise } from "@/exercise/components/CreateExercisePopUp";
import { CreateLecture } from "@/lecture/components/CreateLecturePopUp";
        ...
        <div className="overflow-hidden collapse-content flex flex-col rounded-lg h-50  w-full rounded-sm space-2 px-128 space-y-5">
          ...
          <div className="pt-5">
            ...
            {cachedComponents && cachedComponents.length > 0 && (
              <div>
                <ComponentList sid={sid} components={cachedComponents ?? []} />
                <div className="border-t border-gray" />{" "}
                {/* Divider below ComponentList */}
              </div>
            )}
