        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                  "flex p-1 rounded-md border border-greyscale-border-lighter shadow-xs min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",                variant === "error" &&
