...
export const TopNavBar = () => {
  ...
  return (
    <div className="flex items-center shrink-0 h-16 px-8 border-b border-gray-300">
      ...
      <button className="relative ml-auto text-sm focus:outline-hidden group">
        <div className="dropdown dropdown-end">
          <label tabIndex={0} className="btn btn-ghost hover:bg-transparent">
            <div className="flex items-center justify-between w-10 h-10 rounded-sm">
              <div className="block relative">
                <img
                  alt="profil"
                  src="https://www.tailwind-kit.com/images/person/6.jpg"
                  className="mx-auto object-cover rounded-full h-10 w-10 hover:rounded-sm "
                />
              </div>
            </div>
          </label>
