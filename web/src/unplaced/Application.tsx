    ...
    <main className="grow overflow-x-hidden bg-secondary h-screen font-['Montserrat']">
      ...
      <div className="items-center text-center p-10 pt-20">
        ...
        <p className="text-grayDark text-lg font-normal max-w-[780px] mx-auto">
          Precisamos de algumas informações para aprovar seu acesso de criador
          de conteúdo. Retornaremos com uma resposta via e-mail.
        </p>
      </div>
      ...
      <form className="text-center py-8 px-10 w-full">
        <div className="inline-block">
          ...
          <div className="motivation-form">
            <Motivation
              register={register}
              setIsMotivationFilled={setIsMotivationFilled}
            />
          </div>
          ...
          <div className="w-[1000px] h-[52px] justify-between items-center inline-flex gap-4 mt-16">
            ...
            <button
              ...
              onClick={() => {
                ...
                if (areAllFormsFilledCorrect) openModal();
              }}
