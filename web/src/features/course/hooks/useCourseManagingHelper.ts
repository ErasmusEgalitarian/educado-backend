...
import { useMedia, useCourse, useSections } from "@/course/context/courseStore";
import { useNotifications } from "@/shared/context/NotificationContext";
import { prepareFormData } from "@/unplaced/formDataUtils";

import { SubmitFunction } from "../types/Course";
...
export const useCourseManagingHelper = () => {
  ...
  const courseMissingRequiredFields = () => {
    ...
    const isMissingRequiredFields = Object.values(errors).some(
      (error) => error,
    );
