export const CourseGridCardLoading = () => {
  return (
    <div className="overflow-hidden shadow-lg rounded-sm h-90 w-full cursor-pointer m-auto">
      ...
      <div className="bg-white w-full p-4 space-y-2">
        ...
        <div className="flex items-center mt-4">
          ...
          <div className="flex flex-col justify-between ml-4 text-sm space-y-2">
            <div className="h-10 w-48 bg-gray-200 rounded-sm animate-pulse" />
          </div>
        </div>
      </div>
    </div>
