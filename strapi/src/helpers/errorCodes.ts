...
export const errorCodes: Record<string, errorDetail> = {
  ...
  E0002: {
    code: "E0002",
    message:
      "Users role does not have the necessary permissions for this action",
  },
  E0003: {
    code: "E0003",
  ...
  E0103: {
    code: "E0103",
    message:
      "Account is not verified. Please check your email for a verification link.",
  },
  E0104: {
    code: "E0104",
  ...
  E0606: {
    code: "E0606",
    message:
      "Cannot unsubscribe from course: User is not subscribed to course.",
  },
